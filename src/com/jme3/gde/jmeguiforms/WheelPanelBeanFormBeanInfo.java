...
public class WheelPanelBeanFormBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_contentContainer = 21;
    ...
    private static final int PROPERTY_leftDecoration = 61;
    ...
    private static final int PROPERTY_rightDecoration = 90;
    ...
    private static final int PROPERTY_titleFont = 99;
    private static final int PROPERTY_titleForeground = 100;
    private static final int PROPERTY_titlePainter = 101;
    ...
    private static final int PROPERTY_wheelName = 115;
